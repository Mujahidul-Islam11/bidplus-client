const Footer = () => {
  return (
    ...
    <a href="#">
      ...
      <div>
        <h3 className="font-bold text-xl text-gray-700">Contact Us</h3>
        <div className="flex items-center">
          <h3 className="">Contact Number: 01xxxxxx</h3>
        </div>
        <div className="flex items-center">
          <h3 className="">Email: BidPlus@gmail.com</h3>
        </div>
        <h3 className="">Location: Chattogram, Bangladesh</h3>
      </div>
    </footer>
  );
};
